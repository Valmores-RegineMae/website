...
<?php
 ...
 ?> 
    ...
    <br>
    <div class="">
       <button type="submit" class="button"  name="btnsubmitbooking">
       <img style="height:100px;" name="btnsubmitbooking" border="0" src="<?php echo WEB_ROOT;?>images/Make-a-Payment-button.png" alt="">
       </button>
    </div>
  </div>   
</form>
...
<input type="hidden" name="business" value="JusieAugustine@gmail.com">
...
<input type="hidden" name="return" value="http://localhost/marimar/payment.php">
<input type="hidden" name="cancel_return" value="http://localhost/marimar/index.php">
<input type="hidden" name="currency_code" value="PHP">
<input type="hidden" name="bn" value="PP-BuyNowBF:btn_paynowCC_LG.gif:NonHosted">
<input type="hidden" name="notify_url" value="http://localhost/marimar/index.php">
