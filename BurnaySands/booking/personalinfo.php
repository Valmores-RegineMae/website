		...
		<form class="form-horizontal" action="personalinfo.php" method="post"  name="personal" >    
				 ...
				 <div class="form-group">
			        <div class="col-md-12"> 
					 ...
					 <small>Agree the <a class="toggle-modal"  onclick="OpenPopupCenter('terms_condition.php','Terms And Codition','600','600')" /> TERMS AND CONDITION </a> of this Resort</small> 
