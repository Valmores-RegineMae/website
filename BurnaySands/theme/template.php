...
<html lang="en">
<head>
<title>Burnay Sands Beach Resort</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Burnay Sands Beach Resort template project">
...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <img class="logo_1" src="<?php echo WEB_ROOT;?>images/burnay2.png" alt="">
     <!-- <img class="logo_2" src="<?php echo WEB_ROOT;?>images/burnay1.png" alt=""> -->
      <!--<img class="logo_3" src="<?php echo WEB_ROOT;?>images/burnay1.png" alt="">-->
    </a></div>
    ...
    <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Amenities</a></li> 
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=contact">Contact</a></li>
          <li><a href="<?php echo WEB_ROOT;?>index.html">Reviews&Ratings</a></li>
        </ul>
      </nav>

      <!--<nav class="main_nav navbar-expand-lg navbar-light fixed-top py-3" >
        <a class="navbar-brand" href="#">
              <img src="images/burnay1.png" alt="burnay_logo" width="70" height="70" class="d-inline-block">
              Burnay Sands
            </a>
            <div class="container">
...
<!--         <div class="search_button">
       ...
       <script src="https://www.gstatic.com/dialogflow-console/fast/messenger/bootstrap.js?v=1"></script>
        <df-messenger
          intent="WELCOME"
          chat-title="BurnaySands"
          agent-id="61684f62-251c-4929-88fb-e4ba6698c895"
          language-code="en"
        </df-messenger>
        <!-- Hamburger Button -->
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/burnay1.png" alt=""></a></div>
    </div>
  </div>
  ...
  <div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images/home2.jpg" data-speed="0.8"></div>
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Burnay Sands Resort</h1></div>
      <div class="home_text text-center"> Escape to your own private sanctuary at the Burnay Sands Resort Situated in barangay Poblacion, municipality of Gitagum, Misamis Oriental We offer exclusivity with priority on your privacy and comfort as you relax and spend quality time with your family and friends.</div>
    </div>
  </div>
...
<div class="rooms">
  ...
  <footer class="footer">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images/home1.jpg" data-speed="0.8"></div>
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="footer_logo text-center">
            <a href="#"><img src="images/burnay1.png" alt=""></a>
          </div>
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  ...
                  <i class="fa fa-map-marker fa-5x mb-3" aria-hidden="true"></i>
                    <div>Address:</div>
                    <div>Brgy. Poblacion, Gitagum, Misamis Oriental</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  ...
                  <i class="fa fa-globe fa-5x mb-3" aria-hidden="true"></i>
                    <div>Mail:</div>
                    <div>burnaysands@yahoo.com</div>
                  </div>
                </div>
              </div>
                <div class="map-responsive" style="display: block;">
                  <p align="center"><iframe frameborder="0" scrolling="0" marginheight="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d75067.6802005898!2d124.36999020664123!3d8.571081438843954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32555d98cf750a37%3A0xfd2d7c19e47fafaa!2sBURNAY%20SANDS!5e0!3m2!1sen!2sph!4v1636251045912!5m2!1sen!2sph" allowfullscreen="" loading="lazy"></iframe></p>
                </div>
            </div>
          </div>
